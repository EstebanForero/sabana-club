...
import { getCurrentUser, updateCurrentUser } from '../../backend/user'
...
function RouteComponent() {
  ...
  return <div className='flex flex-col h-full justify-center items-center p-20'>
    ...
    <div>
      ...
      }} buttonName='Actualizar datos' showPasswordFields={false} exemptValues={{ email: currentUser.correo, phone: currentUser.telefono.toString() }} />
    </div>
  </div>
}
